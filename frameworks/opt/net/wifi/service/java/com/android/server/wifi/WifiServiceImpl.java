...
/*added by dangchaobing for wifi led*/
import android.hardware.LedsService;
/*end*/
...
public final class WifiServiceImpl extends IWifiManager.Stub {
    ...
    public synchronized boolean setWifiEnabled(boolean enable) {
        ...
        /*added by dangchaobing for wifi led*/
	    LedsService wlan_led =  new LedsService(); 
		
		if(enable)
		{
			wlan_led.set_wlan_led4(1);
		}
		else
		{
			wlan_led.set_wlan_led4(0);
		}
        /*end*/
        /*
