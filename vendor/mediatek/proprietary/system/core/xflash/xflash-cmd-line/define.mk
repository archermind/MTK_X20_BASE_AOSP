...
INCLUDE_PATH        :=  -I ./	\
						...
						$(if $(LINUX), -I "/opt/QtSDK/Desktop/Qt/473/gcc/include", -I "C:\QtSDK\Desktop\Qt\4.7.4\msvc2008\include") \
						$(if $(LINUX), -I "/opt/QtSDK/Desktop/Qt/473/gcc/include/QtCore", -I "C:\QtSDK\Desktop\Qt\4.7.4\msvc2008\include\QtCore") \
						-I "../inc" \
						-I "../api" \
						-I "./xmain" \
						-I "./core" 
