...
struct hts221_calibration_data {
	unsigned char temperature_calibration[2], temperature_calibration2[2];
	int calibX0, calibX1, calibW0, calibW1;
	unsigned short calibY0, calibY1;
	unsigned short calibZ0a, calibZ0b, calibZ1a, calibZ1b;
	int calibZ0, calibZ1;
...
#define HTS221_SUCCESS                0
#define HTS221_ERR_I2C                -1
#define HTS221_ERR_STATUS             -2
