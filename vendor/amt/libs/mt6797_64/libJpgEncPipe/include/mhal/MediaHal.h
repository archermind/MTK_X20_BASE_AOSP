...
typedef enum {
    ...
    JPEG_OUT_FORMAT_I420,	// YVU420 3 plane
    JPEG_OUT_FORMAT_YV12,       // YVU420 3 plane
    JPEG_OUT_FORMAT_YV12_ANDROID, // YVU420 3 plane, y,u,v plane 16 align
...
{
    void *imageDCParam;
    MUINT32 ISOSpeedRatings;
}MHAL_JPEG_POST_PROC_PARAM;
...
typedef struct
{
    ...
    MHAL_JPEG_POST_PROC_PARAM *postProcessingParam;
